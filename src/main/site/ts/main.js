...
const suggs = document.querySelector('#suggestions');
// Here, when the value of sun is changed, we will call the method postAndUpdate.
// TODO: Do the same for moon and rising
const sunLs = document.querySelector('#sun');
const moonLs = document.querySelector('#moon');
const risingLs = document.querySelector('#rising');
